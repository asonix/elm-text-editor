...
last =
    MaybeZipList.current << MaybeZipList.toEnd
...
currentStyleToMaybe =
    Util.fromMaybe Styles.toMaybe << currentStyle
...
removeCurrentStyle =
    MaybeZipList.removeCurrentBack
...
serializeToString =
    MaybeZipList.serializeToString
